...
<div align="center">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/MaxKuvshinov/MaxKuvshinov/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/MaxKuvshinov/MaxKuvshinov/output/github-snake.svg" />
  <img alt="github-snake" src="https://raw.githubusercontent.com/MaxKuvshinov/MaxKuvshinov/output/github-snake.svg" />
</picture>
</div>
...
- 🧠 Enjoy learning new backend technologies  
- 🔥 Believe in continuous self-improvement  
- ☕ Coffee addict & open-source curious  
...
def backend_expertise():
    return {
        "architecture": ["REST APIs", "OOP", "Microservices", "Design Patterns"],
        "testing": ["Unit Tests", "Pytest", "TDD", "Integration Testing"],
        "devops": ["Docker", "CI/CD Pipelines", "Cloud Deployments", "Infrastructure"],
        "database": ["Query Optimization", "Indexing", "Redis Caching", "ORM"],
...
## 📊 My Stats:
 ...
 [![GitHub Stats](https://github-readme-stats.vercel.app/api?username=MaxKuvshinov&show_icons=true&theme=dark&title_color=58A6FF&icon_color=58A6FF&text_color=FFFFFF&bg_color=000000&hide_border=true)](https://github.com/MaxKuvshinov)
